...
bool
optim::ipso_int(arma::vec& init_out_vals, std::function<double (const arma::vec& vals_inp, arma::vec* grad_out, void* opt_data)> opt_objfn, void* opt_data, double* value_out, optim_opt_settings* opt_params_inp)
{
    bool success = false;
...
bool
optim::ipso(arma::vec& init_out_vals, std::function<double (const arma::vec& vals_inp, arma::vec* grad_out, void* opt_data)> opt_objfn, void* opt_data, optim_opt_settings& opt_params)
{
    return ipso_int(init_out_vals,opt_objfn,opt_data,nullptr,&opt_params);
}
...
bool
optim::ipso(arma::vec& init_out_vals, std::function<double (const arma::vec& vals_inp, arma::vec* grad_out, void* opt_data)> opt_objfn, void* opt_data, double& value_out, optim_opt_settings& opt_params)
{
    return ipso_int(init_out_vals,opt_objfn,opt_data,&value_out,&opt_params);
}
