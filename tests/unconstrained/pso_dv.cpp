...
int main()
{
    ...
    bool success_6 = optim::pso_dv(x_6,unconstr_test_fn_6,&test_6_data,opt_settings_6);
    ...
    optim::pso_dv(x_1,unconstr_test_fn_1,nullptr,opt_settings);
    optim::pso_dv(x_1,unconstr_test_fn_1,nullptr,val_out);
    optim::pso_dv(x_1,unconstr_test_fn_1,nullptr,val_out,opt_settings);

    x_7 = arma::ones(2,1) + 1.0;
    optim::pso_dv(x_7,unconstr_test_fn_7,nullptr,opt_settings);
