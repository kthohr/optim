...
inline
double 
unconstr_test_fn_4_whess(const Vec_t& vals_inp, Vec_t* grad_out, Mat_t* hess_out, void* opt_data)
{
...
inline
double
unconstr_test_fn_4(const Vec_t& vals_inp, Vec_t* grad_out, void* opt_data)
{
