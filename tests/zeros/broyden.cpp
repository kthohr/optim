...
int main()
{
    ...
    BMO_MATOPS_COUT << "broyden: solution to test_1:\n" << x_1 << "\n";
    ...
    BMO_MATOPS_COUT << "broyden: solution to test_2:\n" << x_2 << "\n";
    ...
    BMO_MATOPS_COUT << "broyden with jacobian: solution to test_1:\n" << x_1 << "\n";
    ...
    BMO_MATOPS_COUT << "broyden with jacobian: solution to test_2:\n" << x_2 << "\n";
