...
int main()
{
    ...
    optim::error_reporting(out_vals,x_p,optim_simple_fn_1,NULL,success,&value_out,err_1,err_tol,iter_1,iter_max,conv_failure_switch);
    optim::error_reporting(out_vals,x_p,optim_simple_fn_1,NULL,success,&value_out,err_2,err_tol,iter_2,iter_max,conv_failure_switch);
    ...
    optim::error_reporting(out_vals,x_p,optim_simple_fn_1,NULL,success,&value_out,conv_failure_switch);
    ...
    optim::error_reporting(out_vals,x_p,optim_simple_fn_2,NULL,success,&val_vec_out,err_1,err_tol,iter_1,iter_max,conv_failure_switch);
    optim::error_reporting(out_vals,x_p,optim_simple_fn_2,NULL,success,&val_vec_out,err_2,err_tol,iter_2,iter_max,conv_failure_switch);
